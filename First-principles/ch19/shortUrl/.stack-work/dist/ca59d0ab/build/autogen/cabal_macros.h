...
/* package shortUrl-0.1.0.0 */
#define VERSION_shortUrl "0.1.0.0"
#define MIN_VERSION_shortUrl(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
...
/* package hedis-0.10.2 */
#define VERSION_hedis "0.10.2"
...
#define CURRENT_COMPONENT_ID "shortUrl-0.1.0.0"

#define CURRENT_PACKAGE_KEY "shortUrl-0.1.0.0"
