...
/* package applicativeExercises-0.1.0.0 */
#define VERSION_applicativeExercises "0.1.0.0"
#define MIN_VERSION_applicativeExercises(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
...
#define CURRENT_COMPONENT_ID "applicativeExercises-0.1.0.0-HyjTDpSECPt6Ni14rKmOa6"

#define CURRENT_PACKAGE_KEY "applicativeExercises-0.1.0.0-HyjTDpSECPt6Ni14rKmOa6"
